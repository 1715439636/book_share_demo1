...
function(e) {
        ...
        setImageOrientation: function(e, i, a) {
            if (e && e.length) {
                ...
                function() {
                    ...
                    l = r.offsetWidth,
                    s = t.getRotation(a);
                    if (e.data("orientation", a), n && i.data("orientation", a), 5 > a) return t.setTransform(r, s),
    ...
    i.prototype = {
        ...
        _initTemplateDefaults: function() {
            ...
            M = '<div class="kv-zoom-cache" style="display:none">{zoomContent}</div>',
            L = {
                width: "100%",
                height: "100%",
                "min-height": "480px"
            ...
            e.each(Z.defaults,
            function(t, i) {
                return "allowedPreviewTypes" === t ? void(void 0 === Z.allowedPreviewTypes && (Z.allowedPreviewTypes = i)) : void(Z[t] = e.extend(!0, {},
                i, Z[t]))
            }),
        ...
        _setZoomContent: function(i, a) {
            ...
            h.data("previewId", v),
            m._handler(h.find(".btn-prev"), "click",
            function() {
                m._zoomSlideShow("prev", v)
            }),
            m._handler(h.find(".btn-next"), "click",
            function() {
            ...
            function() {
                ...
                r = function(e) {
                    ...
                    a = m.zoomModalHeight;
                    h.hasClass("file-zoom-fullscreen") && (a = i.outerHeight(!0), e || (a -= t.outerHeight(!0))),
        ...
        _validateImageOrientation: function(e, i, a, r, n, o, l) {
            ...
            (d = s ? s["0th"][piexif.ImageIFD.Orientation] : null) ? (t.setImageOrientation(e, c.$preview.find("#zoom-" + a + " img"), d), c._raise("fileimageoriented", {
                $img: e,
                file: i
        ...
        _validateImage: function(t, i, a, r, n, o) {
            ...
            function() {
                ...
                c.resizeImage || (c._checkDimensions(f, "Large", m, u, i, "Width", l), c._checkDimensions(f, "Large", m, u, i, "Height", l)),
        ...
        readFiles: function(i) {
            ...
            a = function(x) {
                ...
                if (B) {
                    ...
                    if (0 === Z.length) return S = r.msgInvalidFileName.replace("{name}", t.htmlEncode(B.name, "[unknown]")),
                    void y(S, B, R, x);
                    ...
                    void y(S, B, R, x);
                    if (!r.showPreview) return r.isAjaxUpload && r.addToStack(B),
                    setTimeout(function() {
                        a(x + 1),
                        r._updateFileDetails(f)
                    },
                    ...
                    if (!C && N > b) return r.addToStack(B),
